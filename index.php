    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.html">Serendipity Hotel</a></div>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li disabled><a href="login.php">Rooms</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
                  ...
                  <div class="col-md-12 site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="200">
                    ...
                    <div class="col-md-6 text order-1">
                      <span class="d-block mb-4"><span class="text-uppercase letter-spacing-2">Opened :</span><br><span class="display-4 text-primary">10 AM - 09 PM</span> </span>
        ...
        <div class="container">
          <div class="row mb-4">
            ...
            <div class="col-md-3 mb-5">
              ...
              <li><a href="login.php">Standard Room</a></li>
                <li><a href="login.php">Deluxe Room</a></li>
                <li><a href="login.php">Suite Room</a></li>
              </ul>
            </div>
